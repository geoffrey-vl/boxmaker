...
class Panel:
    ...
    def __init__(self, name, x_coord, y_coord, (a,b,c,d) , x , y, my_dict):
        ...
        self.bottom_edge = Edge('B',   x_coord ,     y_coord , ( d, a),(-b, a ), a ,1- 2*a , x, my_dict)

        self.right_edge = Edge('R', x_coord + x,  y_coord ,    (-b, a),(-b,-c ),  b  , 2*b-1, y, my_dict)

        self.top_edge = Edge('T',x_coord + x,  y_coord + y ,   (-d,-c),( d,-c ),  c , 2*c-1,  x, my_dict)

        self.left_edge = Edge('L',  x_coord,      y_coord + y, ( d,-c),( d, a ), d , 1 -2*d,  y, my_dict)
